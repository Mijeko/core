...
workDir='/root/backup/work/' #Рабочая дира скрипта, в конце должен быть слеш.
...
usePassiveMode='0'
HOST='iks.myqnapcloud.com' #FTPserver
USER='bu_sinar' #FTPuser
PASSWD='Arl1DG5mpE' #FTPpass
ftpdestdir='/bu_sinar' #директория на ftp сервере, чтобы делать копии в корень, оставь переменную пустой. Директория должна быть предварительно создана руками. 
